...
internal static class DaemonServiceTestContext
{
    ...
    internal sealed class StubSupervisorProjectGateway : IDaemonProjectLifecycleGateway
    {
        ...
        public ICommandProgressSink? LastEnsureRunningSupervisorProgressSink { get; private set; }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            LastEnsureRunningSupervisorProgressSink = supervisorProgressSink;
            LastEnsureRunningCancellationToken = cancellationToken;

            if (EnsureRunningHandler != null)
            {
                return EnsureRunningHandler(unityProject, timeout, editorMode, onStartupBlocked, progressObserver, supervisorProgressSink, cancellationToken);
            }
