...
{
    private static readonly UcliCodeValue CustomOperationMetadataErrorCode = new("OPERATION_METADATA_CUSTOM_ERROR");
    ...
    public static TheoryData<int, UcliCodeValue> ContextResolutionErrorCases => new()
    {
