...
public sealed class UnityExecutionModeDecisionServiceTests
{
    ...
    public async Task Decide_WithDaemonMode_WhenDaemonIsRunning_ReturnsDaemonTarget ()
    {
        ...
        var result = await service.DecideAsync(UnityExecutionMode.Daemon, CreateContext(), DefaultTimeout, CancellationToken.None);
    ...
    public async Task Decide_WithAutoMode_WhenDaemonIsNotRunning_ReturnsOneshotTarget ()
    {
        ...
        var result = await service.DecideAsync(UnityExecutionMode.Auto, CreateContext(), DefaultTimeout, CancellationToken.None);
    ...
    public async Task Decide_WithOneshotMode_WhenDaemonIsRunning_ReturnsContractError ()
    {
        ...
        var result = await service.DecideAsync(UnityExecutionMode.Oneshot, CreateContext(), DefaultTimeout, CancellationToken.None);
    ...
    public async Task Decide_WhenCanceled_ThrowsOperationCanceledException ()
    {
        ...
        await Assert.ThrowsAsync<OperationCanceledException>(async () =>
        {
            await TestAwaiter.WaitAsync(
                service.DecideAsync(UnityExecutionMode.Auto, CreateContext(), DefaultTimeout, cancellationTokenSource.Token).AsTask(),
    ...
    public async Task Decide_WithNonPositiveTimeout_ThrowsArgumentOutOfRangeException (int timeoutMilliseconds)
    {
        ...
        {
            await TestAwaiter.WaitAsync(
                service.DecideAsync(UnityExecutionMode.Auto, CreateContext(), TimeSpan.FromMilliseconds(timeoutMilliseconds), CancellationToken.None).AsTask(),
