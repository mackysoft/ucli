...
internal static class UcliConfigStoreTestSupport
{
    ...
    [
        ...
        new(UcliCommandIds.ProgramPlan.Name, 20000),
        new(UcliCommandIds.ProgramRun.Name, 1800000),
        new(UcliCommandIds.ProgramStatus.Name, 10000),
        new(UcliCommandIds.ProgramCancel.Name, 60000),
        ...
        new(UcliCommandIds.ScreenshotGame.Name, 3000),
        new(UcliCommandIds.ScreenshotScene.Name, 3000),
        new(UcliContractConstants.Config.IpcTimeoutCommandRecordingStart, UcliContractConstants.Config.IpcTimeoutDefaultRecordingStartMilliseconds),
        new(UcliContractConstants.Config.IpcTimeoutCommandRecordingStatus, UcliContractConstants.Config.IpcTimeoutDefaultRecordingStatusMilliseconds),
        new(UcliContractConstants.Config.IpcTimeoutCommandRecordingStop, UcliContractConstants.Config.IpcTimeoutDefaultRecordingStopMilliseconds),
