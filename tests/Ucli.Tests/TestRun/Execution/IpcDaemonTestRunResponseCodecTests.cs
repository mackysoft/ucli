...
public sealed class IpcDaemonTestRunResponseCodecTests
{
    ...
    public void TryDecode_WithValidResponse_ReturnsTrueAndExitCode ()
    {
        ...
        var success = IpcDaemonTestRunResponseCodec.TryDecode(response, out var exitCode, out var errorMessage);
    ...
    public void TryDecode_WithPayloadMissingExitCode_ReturnsFalse ()
    {
        ...
        var success = IpcDaemonTestRunResponseCodec.TryDecode(response, out _, out var errorMessage);
