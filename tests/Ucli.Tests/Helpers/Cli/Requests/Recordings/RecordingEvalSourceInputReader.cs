...
{
    private readonly Func<string?, AbsolutePath?, CancellationToken, ValueTask<EvalSourceInputReadResult>> handler;

    private readonly List<Invocation> invocations = [];

    public RecordingEvalSourceInputReader (
        Func<string?, AbsolutePath?, CancellationToken, ValueTask<EvalSourceInputReadResult>> handler)
    {
