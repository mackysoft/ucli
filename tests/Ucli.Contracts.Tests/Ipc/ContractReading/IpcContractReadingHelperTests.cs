...
public sealed class IpcContractReadingHelperTests
{
    [Fact]
    [Trait("Size", "Small")]
    public void OperationContractReadPolicy_ExposesExpectedStrictAndPermissiveFlags ()
    {
        var strict = OperationContractReadPolicy.StrictExecute;
        var permissive = OperationContractReadPolicy.PermissivePreflight;
