...
```json
{
  "operation": {
    ...
    "assurance": {
      ...
      "touchedContract": "Reports the scene resource as an observed context, not as a persisted mutation.",
...
```json
{
  "operation": {
    ...
    "assurance": {
      ...
      "touchedContract": "Reports the scene resource as an observed context.",
      "readPostconditionContract": "Does not stale read surfaces by itself.",
