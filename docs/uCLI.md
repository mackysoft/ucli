...
- `codeContract`：source code を受け取る operation だけが持つ任意 contract。entry point 署名、uCLI が提供する source-visible API、戻り値制約を表す。Unity API や project assembly の参照可否を列挙する allowlist ではない
