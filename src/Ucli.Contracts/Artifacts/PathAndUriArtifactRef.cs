...
/// <summary> References the same finalized artifact bytes by both a path and an absolute URI. </summary>
public sealed record PathAndUriArtifactRef : ArtifactRef
{
    /// <summary> Initializes a path-and-URI artifact reference. </summary>
    ...
    /// <param name="uri"> The absolute artifact URI for the same finalized bytes. </param>
    ...
    private protected override ArtifactLocationKind LocationKindCore =>
        ArtifactLocationKind.PathAndUri;
    ...
    /// <summary> Gets the absolute artifact URI for the same finalized bytes. </summary>
    [JsonInclude]
    [JsonRequired]
