...
internal static class OperationContractReader
{
    ...
    {
        return JsonObjectPropertyReader.FindUnknownProperty(operationElement, AllowedOperationProperties);
    }

    /// <summary> Reads operation identifier based on the provided contract-read policy. </summary>
    /// <param name="operationElement"> The operation JSON object. </param>
    /// <param name="policy"> The contract-read strictness policy. </param>
    ...
    public static bool TryReadOperationId (
        ...
        in OperationContractReadPolicy policy,
    ...
    /// <summary> Reads operation name based on the provided contract-read policy. </summary>
    /// <param name="operationElement"> The operation JSON object. </param>
    /// <param name="policy"> The contract-read strictness policy. </param>
