...
/// <summary>Represents a <c>recording.status</c> request for one durable recording.</summary>
public sealed record IpcGameViewRecordingStatusRequest
{
    [JsonConstructor]
    public IpcGameViewRecordingStatusRequest (
        Guid recordingId,
