...
{
    /// <summary> Gets the daemon endpoint prefix used for named pipes. </summary>
    public const string DaemonAddressPrefix = "ucli-daemon-";

    /// <summary> Gets the supervisor endpoint prefix used for named pipes. </summary>
    public const string SupervisorAddressPrefix = "ucli-supervisor-";

    /// <summary> Gets the GUI supervisor endpoint prefix used for named pipes. </summary>
