...
/// <summary> Represents one resolved Unity project identity. </summary>
public sealed record UnityProjectIdentity
{
    /// <summary> Initializes a resolved Unity project identity. </summary>
    /// <param name="projectPath">
    /// The Unity project root path text carried by the execution provider. The receiving application
    ...
    /// <summary>
    /// Gets the Unity project root path text carried by the execution provider. Consumers must validate it before
