...
/// <summary> Interprets uCLI nullable Int32 minimum declarations as exact provider metadata. </summary>
public sealed class UcliNullableInt32MinimumAttributeInterpreter :
    IJsonContractAttributeInterpreter<UcliInt32MinimumAttribute, int?>
{
    /// <inheritdoc />
    public string StableId => "mackysoft.ucli.nullable-int32-minimum";
