...
public static class ExecuteRequestErrorCodes
{
    ...
    public static readonly UcliCodeValue RequestIdConflict = new("REQUEST_ID_CONFLICT");
    ...
    public static readonly UcliCodeValue HierarchyPathUnrepresentableObjects = new("HIERARCHY_PATH_UNREPRESENTABLE_OBJECTS");
}
