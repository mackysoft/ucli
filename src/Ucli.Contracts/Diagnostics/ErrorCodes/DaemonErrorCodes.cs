...
public static class DaemonErrorCodes
{
    ...
    public static readonly UcliCode DaemonStartProcessExited = new("DAEMON_START_PROCESS_EXITED");
    ...
    public static readonly UcliCode PackageResolutionFailed = new("PACKAGE_RESOLUTION_FAILED");

    /// <summary> Gets the error code emitted when a uCLI plugin dependency is missing during startup. </summary>
    public static readonly UcliCode UcliPluginDependencyMissing = new("UCLI_PLUGIN_DEPENDENCY_MISSING");

    /// <summary> Gets the error code emitted when the uCLI plugin fails to compile during startup. </summary>
    public static readonly UcliCode UcliPluginCompileFailed = new("UCLI_PLUGIN_COMPILE_FAILED");

    /// <summary> Gets the error code emitted when precompiled assemblies conflict during Unity startup. </summary>
    public static readonly UcliCode PrecompiledAssemblyConflict = new("PRECOMPILED_ASSEMBLY_CONFLICT");
}
