...
public static class EditorLifecycleErrorCodes
{
    ...
    public static readonly UcliErrorCode EditorStarting = new("EDITOR_STARTING");

    /// <summary> Gets the error code emitted when Unity editor is busy with internal work. </summary>
    public static readonly UcliErrorCode EditorBusy = new("EDITOR_BUSY");
    ...
    public static readonly UcliErrorCode EditorModalBlocked = new("EDITOR_MODAL_BLOCKED");

    /// <summary> Gets the error code emitted when Unity editor is in Safe Mode. </summary>
    public static readonly UcliErrorCode EditorSafeMode = new("EDITOR_SAFE_MODE");
