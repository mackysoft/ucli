...
public static class UcliPublicCommandCatalog
{
    ...
    [
        ...
        UcliCommandIds.Call,
        UcliCommandIds.Eval,
        UcliCommandIds.Program,
        UcliCommandIds.ProgramPresets,
        UcliCommandIds.ProgramPresetsList,
        UcliCommandIds.ProgramPresetsDescribe,
        UcliCommandIds.ProgramValidate,
        UcliCommandIds.ProgramPlan,
        ...
        UcliCommandIds.Schema,
        UcliCommandIds.SchemaList,
        UcliCommandIds.SchemaGet,
        UcliCommandIds.SchemaExport,
        UcliCommandIds.Codes,
        UcliCommandIds.CodesList,
        UcliCommandIds.CodesDescribe,
        UcliCommandIds.Play,
