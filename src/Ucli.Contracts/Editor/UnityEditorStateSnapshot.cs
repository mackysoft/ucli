...
public sealed record UnityEditorStateSnapshot
{
    ...
    [JsonInclude]
    [JsonRequired]
    public UnityEditorMode EditorMode { get; private init; }

    /// <summary> Gets the Editor lifecycle state. </summary>
    [JsonInclude]
    [JsonRequired]
    public UnityEditorLifecycleState LifecycleState { get; private init; }

    /// <summary> Gets the script-compilation state. </summary>
    [JsonInclude]
    [JsonRequired]
    public UnityEditorCompileState CompileState { get; private init; }

    /// <summary> Gets the lifecycle generation snapshot. </summary>
    [JsonInclude]
    [JsonRequired]
    public UnityEditorGenerationSnapshot Generations { get; private init; }

    /// <summary> Gets the Play Mode subsystem snapshot. </summary>
    [JsonInclude]
    [JsonRequired]
    public UnityEditorPlayModeSnapshot PlayMode { get; private init; }
}
