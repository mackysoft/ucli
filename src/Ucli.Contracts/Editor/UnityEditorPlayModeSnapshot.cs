...
public sealed record UnityEditorPlayModeSnapshot
{
    /// <summary> Initializes a Play Mode subsystem snapshot. </summary>
    [JsonConstructor]
    public UnityEditorPlayModeSnapshot (
    ...
    [JsonInclude]
    [JsonRequired]
    public UnityEditorPlayModeState State { get; private init; }

    /// <summary> Gets the current Play Mode transition. </summary>
    [JsonInclude]
    [JsonRequired]
    public UnityEditorPlayModeTransition Transition { get; private init; }
