...
/// <summary> Defines normalized Unity Editor lifecycle states. </summary>
[VocabularyDefinition]
public enum UnityEditorLifecycleState
{
    /// <summary> Editor startup work is still running. </summary>
    [VocabularyText("starting")]
    Starting = 0,

    /// <summary> The execution provider is recovering after an Editor lifecycle transition. </summary>
    ...
    /// <summary> The lifecycle cannot be observed because the execution provider is unavailable. </summary>
