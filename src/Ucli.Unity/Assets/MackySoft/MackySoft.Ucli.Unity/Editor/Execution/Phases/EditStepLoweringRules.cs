...
{
    /// <summary> Defines Unity primitive lowering rules for public <c>kind:"edit"</c> steps. </summary>
    internal static class EditStepLoweringRules
    {
        /// <summary>
        ...
        public static EditTargetKind DetermineDirectSelectionTargetKind (
        ...
        public static bool TryGetActionOperationName (
            ...
            EditTargetKind? parentTargetKind,
            ...
            out string errorMessage)
        {
            ...
            {
                EditTargetKind.Component => Succeed(UcliPrimitiveOperationNames.CompSet, out operationName, out errorMessage),
                EditTargetKind.Asset => Succeed(UcliPrimitiveOperationNames.AssetSet, out operationName, out errorMessage),
        ...
        private static bool TryResolveCreatePrefab (
            ...
            out string errorMessage)
        {
            if (targetKind != EditTargetKind.GameObject)
            {
        ...
        private static bool TryResolveSceneComponent (
            ...
            out string errorMessage)
        {
            return contextKind == IpcEditStepContract.ContextKind.Scene && targetKind == EditTargetKind.Component
        ...
        private static bool TryResolveGameObjectTarget (
            ...
            out string errorMessage)
        {
            return targetKind == EditTargetKind.GameObject
                ? Succeed(primitiveOperationName, out operationName, out errorMessage)
                : Fail(failureMessage, out operationName, out errorMessage);
        }
            ...
            out string errorMessage)
        {
            ...
            return parentTargetKind == EditTargetKind.GameObject
