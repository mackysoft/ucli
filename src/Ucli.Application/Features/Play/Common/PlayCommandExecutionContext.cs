...
/// <param name="Session">
/// The registered GUI daemon session for a new execution, or <see langword="null" /> when an
/// existing execution will reconnect through its authoritative Start Record.
/// </param>
