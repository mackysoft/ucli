    ...
    DaemonDiagnosis? Diagnosis)
{
    ...
    public static DaemonStartResult Started (DaemonSession session)
    {
        ...
        return new DaemonStartResult(DaemonStartStatus.Started, session, null, null);
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(session);
        return new DaemonStartResult(DaemonStartStatus.AlreadyRunning, session, null, null);
    }
        ...
        DaemonDiagnosis? diagnosis = null)
    {
        ...
        return new DaemonStartResult(DaemonStartStatus.Failed, null, error, diagnosis);
    }
}
