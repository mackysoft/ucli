...
internal static class UnityProcessErrorCodes
{
    ...
    public static readonly UcliCode UnityProjectAlreadyOpen = new UcliCode("UNITY_PROJECT_ALREADY_OPEN");

    /// <summary> Gets the error code used when Unity lock-file ownership cannot be determined safely. </summary>
    public static readonly UcliCode UnityProjectLockAmbiguous = new UcliCode("UNITY_PROJECT_LOCK_AMBIGUOUS");

    /// <summary> Gets the error code used when stale Unity lock-file cleanup fails. </summary>
    public static readonly UcliCode UnityProjectLockCleanupFailed = new UcliCode("UNITY_PROJECT_LOCK_CLEANUP_FAILED");
}
