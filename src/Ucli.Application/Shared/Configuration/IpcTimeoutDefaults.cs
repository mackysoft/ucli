...
internal static class IpcTimeoutDefaults
{
    ...
    [
        ...
        (UcliCommandIds.ProgramPlan, 20000),
        (UcliCommandIds.ProgramRun, 1800000),
        (UcliCommandIds.ProgramStatus, 10000),
        (UcliCommandIds.ProgramCancel, 60000),
        ...
        (UcliCommandIds.ScreenshotGame, 3000),
        (UcliCommandIds.ScreenshotScene, 3000),
        (UcliCommandIds.RecordingStart, 180000),
        (UcliCommandIds.RecordingStatus, 5000),
        (UcliCommandIds.RecordingStop, 60000),
