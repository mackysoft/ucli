...
internal sealed class DaemonCleanupCommandService : IDaemonCleanupCommandService
{
    ...
    /// <summary> Initializes a new instance of the <see cref="DaemonCleanupCommandService" /> class. </summary>
    ...
    public DaemonCleanupCommandService (
