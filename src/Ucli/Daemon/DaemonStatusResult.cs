    ...
    ExecutionError? Error)
{
    ...
    public static DaemonStatusResult Running (DaemonSession session)
    {
        ...
        return new DaemonStatusResult(DaemonStatusKind.Running, session, null);
    }
    ...
    {
        return new DaemonStatusResult(DaemonStatusKind.NotRunning, null, null);
    }
    ...
    /// <exception cref="ArgumentNullException"> Thrown when <paramref name="session" /> is <see langword="null" />. </exception>
    public static DaemonStatusResult Stale (DaemonSession session)
    {
        ArgumentNullException.ThrowIfNull(session);
        return new DaemonStatusResult(DaemonStatusKind.Stale, session, null);
    }
    ...
    public static DaemonStatusResult Failure (ExecutionError error)
    {
        ...
        return new DaemonStatusResult(DaemonStatusKind.Failed, null, error);
    }
}