...
internal sealed record UnityEditorModeOptionNormalizationResult (
    ...
    ExecutionError? Error)
{
    ...
    public static UnityEditorModeOptionNormalizationResult Success (UnityEditorMode? editorMode)
    {
        return new UnityEditorModeOptionNormalizationResult(editorMode, null);
    }

    /// <summary> Creates a failed normalization result. </summary>
    /// <param name="error"> The normalization error. </param>
    /// <returns> The failed result. </returns>
    public static UnityEditorModeOptionNormalizationResult Failure (ExecutionError error)
    {
        ArgumentNullException.ThrowIfNull(error);
        return new UnityEditorModeOptionNormalizationResult(null, error);
    }
}
