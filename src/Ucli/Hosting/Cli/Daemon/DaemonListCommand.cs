...
internal sealed class DaemonListCommand
{
    ...
    /// <exception cref="ArgumentNullException"> Thrown when <paramref name="daemonListService" /> is <see langword="null" />. </exception>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var executionResult = await daemonListService.GetList(projectPath, timeout, cancellationToken).ConfigureAwait(false);
