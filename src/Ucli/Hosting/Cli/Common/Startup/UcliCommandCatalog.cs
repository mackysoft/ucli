...
/// <summary> Provides the single command catalog used for registration and pre-dispatch validation. </summary>
internal static class UcliCommandCatalog
{
    ...
    /// <returns> <see langword="true" /> when the root command has validated subcommands. </returns>
