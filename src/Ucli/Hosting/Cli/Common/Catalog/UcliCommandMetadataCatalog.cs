...
namespace MackySoft.Ucli.Hosting.Cli.Common.Catalog;

/// <summary> Provides side-effect-free command metadata used before framework dispatch. </summary>
internal static class UcliCommandMetadataCatalog
{
    private static readonly string[] RegisteredRootCommands =
    [
    ...
    private static readonly string[] StandaloneCommandPaths =
    [
        UcliCommandNames.Init,
        UcliCommandNames.Status,
        UcliCommandNames.Refresh,
    ...
    private static readonly HashSet<string> RegisteredRootCommandSet = new(RegisteredRootCommands, StringComparer.Ordinal);
    ...
    {
        var commandPathCount = StandaloneCommandPaths.Length;
        for (var i = 0; i < CommandGroups.Length; i++)
        {
        ...
        for (var i = 0; i < StandaloneCommandPaths.Length; i++)
        {
            commandPaths[index] = StandaloneCommandPaths[i];
            index++;
        }
