...
internal sealed class CliExecutionRunner
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (preDispatchErrorResult is CommandResult preDispatchError)
        {
            commandResultWriter.WriteToStandardOutput(preDispatchError);
            Environment.ExitCode = preDispatchError.ExitCode;
        ...
        if (parseErrorResult is CommandResult parseError)
        {
            commandResultWriter.WriteToStandardOutput(parseError);
            Environment.ExitCode = parseError.ExitCode;
        }
