...
{
    private readonly IDaemonCleanupCommandService daemonCleanupCommandService;

    /// <summary> Initializes a new instance of the <see cref="DaemonCleanupCommand" /> class. </summary>
    /// <param name="daemonCleanupCommandService"> The daemon-cleanup command service dependency. </param>
    /// <exception cref="ArgumentNullException"> Thrown when <paramref name="daemonCleanupCommandService" /> is <see langword="null" />. </exception>
    public DaemonCleanupCommand (IDaemonCleanupCommandService daemonCleanupCommandService)
    {
        this.daemonCleanupCommandService = daemonCleanupCommandService ?? throw new ArgumentNullException(nameof(daemonCleanupCommandService));
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var executionResult = await daemonCleanupCommandService.Cleanup(projectPath, timeout, cancellationToken).ConfigureAwait(false);
