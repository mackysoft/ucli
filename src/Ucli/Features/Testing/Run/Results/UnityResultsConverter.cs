...
internal sealed class UnityResultsConverter : IUnityResultsConverter
{
    ...
    /// <summary> Initializes a new instance of the <see cref="UnityResultsConverter" /> class with default parser and writer dependencies. </summary>
    public UnityResultsConverter ()
        : this(new UnityResultsXmlParser(), new UnityResultsArtifactWriter())
    {
    }
