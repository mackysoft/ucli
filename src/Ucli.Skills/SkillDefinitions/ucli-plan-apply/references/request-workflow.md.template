...
## Execution
1. Run `ucli validate` and fix static contract errors first.
2. Run `ucli plan` to preview targets, changed state, touched contexts, and plan token behavior.
3. Run `ucli call` only after reviewing the plan.
