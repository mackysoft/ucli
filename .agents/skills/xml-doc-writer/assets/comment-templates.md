...
## 同期メソッド
```csharp
/// <summary> Performs the operation and updates the target state. </summary>
...
```csharp
/// <summary> Loads the catalog into memory. </summary>
...
## プロパティ
```csharp
/// <summary> Gets the current balance snapshot. </summary>
