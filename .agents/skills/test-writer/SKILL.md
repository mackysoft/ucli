...
## 出力
- 契約に対応した新規/更新テスト。
- `references/report-template.md` に従ったレポート。
- 必要時に `references/execution-handoff.md` を使った引き継ぎメモ。
...
- テストリスト: [references/test-list-template.md](references/test-list-template.md)
- レポート雛形: [references/report-template.md](references/report-template.md)
