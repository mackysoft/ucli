---
name: branch-create
description: Issue から規約準拠ブランチを作成または再利用する。Issue Number or URL と任意の Branch Type/Base Branch/Branch Name を受け取り、`codex/<type>/issue-<N>-<branch_name>` 形式でブランチを確定する。
---
...
## 4. ブランチ名を組み立てる
- 形式は必ず `codex/<type>/issue-<N>-<branch_name>` とする。
...
# Definition of Done
- ブランチ名が `codex/<type>/issue-<N>-<branch_name>` 形式で確定している。
